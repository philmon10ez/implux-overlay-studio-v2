/**
 * Client-side trigger evaluation for preview only — mirrors backend
 * `recommendationRuleEvaluators.js` so pass/fail matches production logic
 * against the mock storefront context.
 */
 ...
 */
export function evaluateRecommendationTriggersPreview(conditions, ctx) {
